...
const News = () => {
  ...
  const blog1Link = "https://medium.com/@4shutosh/the-mighty-sar-pass-c2fb7b5a61c2"
          ...
          <li>
            <div className="list_inner">
              <div className="image" onClick={{}}>
                <img src="assets/img/thumbs/blog1.jpg" alt="thumb" />
                <div
                  className="main"
                  style={{
                    backgroundImage: "url(assets/img/news/blog1.jpg)",
                  }}>
                </div>
              </div>
              {/* END IMAGE */}
              <div className="details">
                <div className="extra">
                  <p className="date">
                    By <a href={`${blog1Link}`} target="_blank" rel="noreferrer">Ashutosh Singh</a>
                ...
                <h3 className="title" >
                  <a href={`${blog1Link}`} target="_blank">
                    The Mighty — Sar Pass
                  </a>
                </h3>
                <div className="tokyo_tm_read_more">
                  <a href={`${blog1Link}`} target="_blank" rel="noreferrer">
                    <span>Read More</span>
                  </a>
                </div>
