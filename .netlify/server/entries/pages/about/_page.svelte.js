...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `<!-- HEAD_svelte-117abv1_START -->${$$result.title = `<title>About - ${escape(SITE_TITLE)}</title>`, ""}<link rel="canonical"${add_attribute("href", SITE_URL, 0)}><link rel="alternate" type="application/rss+xml"${add_attribute("href", SITE_URL + "/api/rss.xml", 0)}><meta property="og:url"${add_attribute("content", SITE_URL, 0)}><meta property="og:type" content="article"><meta property="og:title"${add_attribute("content", SITE_TITLE, 0)}><meta name="Description"${add_attribute("content", SITE_DESCRIPTION, 0)}><meta property="og:description"${add_attribute("content", SITE_DESCRIPTION, 0)}><meta property="og:image"${add_attribute("content", DEFAULT_OG_IMAGE, 0)}><meta name="twitter:card" content="summary"><meta name="twitter:creator"${add_attribute("content", "@" + MY_TWITTER_HANDLE, 0)}><meta name="twitter:titl\`e"${add_attribute("content", SITE_TITLE, 0)}><meta name="twitter:description"${add_attribute("content", SITE_DESCRIPTION, 0)}><meta name="twitter:image"${add_attribute("content", DEFAULT_OG_IMAGE, 0)}><!-- HEAD_svelte-117abv1_END -->`, ""} <h1 class="text-4xl font-catamaran text-semibold mt-16 text-colorOnSurface dark:text-colorOnSurfaceDark mb-10" data-svelte-h="svelte-148kakk">About Ashutosh</h1> <section class="w-full font-catamaran text-textBody dark:text-textBodyDark font-normal text-start text-xl" data-svelte-h="svelte-1uyf36w"><p>Hola! I am a software engineer by profession -- <b>Android Engineer</b>.</p> <p>I was fortunate to be born in the era characterised by accelerated
		...
		softwares.</p> <p class="mt-4">I’ve worked for multiple small scale businesses to help them grow with the
		...
		creation of a social media platform for investors at <a class="underline" href="https://www.tickertape.in/" target="_blank">Tickertape</a> in the fintech sector.</p> <p class="mt-4">At the present time, I contribute to <a class="underline" href="https://www.jiocinema.com/" target="_blank">JioCinema</a> one of India&#39;s premier OTT platforms. Primarily towards the development and
		enhancement of the Android Application.</p> <p class="mt-4">More on my personal side of life: I like to take up challenges. And I
		...
		injuries and incorporate healthy-lifestyle.</p> <p class="mt-4 mb-14">Exciting project / idea / general conversation? feel free to send a message: <a class="underline" href="${"https://twitter.com/messages/compose?recipient_id=" + escape(704722666188505100, true)}" target="_blank">Twitter</a>
		or
		<a class="underline" href="mailto: 4shutoshsingh@gmail.com" target="_blank">Email</a>
		:)
